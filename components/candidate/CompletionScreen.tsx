...
export default function CompletionScreen({ candidateName, jobTitle, isExpired }: Props) {
  if (isExpired) {
    return (
      <div className="min-h-screen bg-[#0B1711] flex items-center justify-center p-4">
        <div className="max-w-md text-center">
          ...
          <p className="text-[#8FA89A] text-base leading-relaxed">
    ...
    <div className="min-h-screen bg-[#0B1711] flex items-center justify-center p-4">
      <div className="w-full max-w-md text-center">
        ...
        <div className="relative inline-flex items-center justify-center mb-8">
          <div className="w-24 h-24 rounded-full bg-[#B8E04A]/15 flex items-center justify-center">
            <CheckCircle2 className="h-12 w-12 text-[#B8E04A]" />
          </div>
        </div>
        ...
        <p className="text-[#8FA89A] text-base leading-relaxed mb-8">
        ...
        <div className="bg-[#11231A] rounded-2xl border border-[#1E3A2B] p-6 text-left space-y-3">
          <p className="text-xs font-medium text-[#8FA89A] uppercase tracking-wider mb-4">What happens next</p>
          {[
            ...
            <div key={i} className="flex items-start gap-3 text-sm text-[#D6E4DC]">
              <div className="w-5 h-5 rounded-full bg-[#B8E04A]/15 text-[#B8E04A] text-xs flex items-center justify-center shrink-0 mt-0.5 font-semibold">
                {i + 1}
              </div>
              {step}
            </div>
